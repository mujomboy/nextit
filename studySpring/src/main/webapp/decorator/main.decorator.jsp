	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item active"><a class="nav-link"
				href="index.html"> <i class="fas fa-fw fa-tachometer-alt"></i> <span></span></a>
			</li>
			...
			<c:choose>
				<c:when test="${loginInfo ne null }">
					...
					<li class="nav-item"><a class="nav-link"
						href='<c:url value="/session/actionLogoutProc.do"/>'> <i
							class="fas fa-fw fa-chart-area"></i> <span>로그아웃</span></a></li>
				...
				<c:otherwise>
					...
					<!-- Nav Item - Charts -->
					<li class="nav-item"><a class="nav-link"
						href='<c:url value="/session/loginFront.do"/>'> <i
							class="fas fa-fw fa-chart-area"></i> <span>로그인</span></a></li>
				...
				<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item"
							href="<c:url value="/member/memberList.do" />">회원 목록</a> <a
							class="collapse-item"
							href="<c:url value="/member/memberInsertFront.do" />">회원 등록</a>
					</div>
				</div></li>
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				<div id="collapseUtilities" class="collapse"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="<c:url value='/board/boardListFront.do'/>">목록</a> <a
						...
						<li class="nav-item dropdown no-arrow"><a
							...
							aria-expanded="false"> <span
								class="mr-2 d-none d-lg-inline text-gray-600 small">
									${loginInfo.usrName eq null ? 'guest' : loginInfo.usrName} </span> <img
							...
							<div
								...
								<c:if test="${loginInfo ne null }">
									...
									<a class="dropdown-item" href="${memberUrl }"> <i
								...
								<c:choose>
									...
									<c:otherwise>
										<a class="dropdown-item"
											href="<c:url value="/session/actionLogoutProc.do"/>" />
