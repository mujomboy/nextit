			...
			<div class="col-md-4">
				<div class="productbox">
					<div class="fadeshop">
						...
						<span class="maxproduct"><img src="<c:url value="images/product1-1.jpg"/>" alt=""></span>
					</div>
			...
			<div class="col-md-4">
				<div class="productbox">
					<div class="fadeshop">
						...
						<span class="maxproduct"><img src="<c:url value="images/product2.jpg"/>" alt=""></span>
					</div>
					<div class="product-details">
						<a href="#">
			...
			<div class="col-md-4">
				<div class="productbox">
					<div class="fadeshop">
						...
						<span class="maxproduct"><img src="<c:url value="images/product2-3.jpg" />" alt=""></span>
					</div>
					<div class="product-details">
						<a href="#">
						<h1>Biscaya Theme</h1>
